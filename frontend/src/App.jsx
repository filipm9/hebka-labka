    ...
    <div className="max-w-5xl mx-auto p-6 pb-32 space-y-6">
      <header className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-2 items-center">
          <button
            className="px-4 py-2 rounded-xl text-xs font-medium transition-all text-beige-500 hover:text-blush-500 hover:bg-blush-50/50 flex items-center gap-1.5"
      ...
      <VoiceRecorder 
        ...
        onCloseSavedList={() => setShowVoiceNotes(false)}
      />
